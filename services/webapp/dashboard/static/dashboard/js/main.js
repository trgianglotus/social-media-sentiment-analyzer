...
;(function(window) {
	...
	function StackFx(el) {
		...
		this.DOM.title = this.DOM.caption.querySelector('.grid__item-titlex');
		this.DOM.columns = {left: this.DOM.caption.querySelector('.column--leftx'), right: this.DOM.caption.querySelector('.column--rightx')};
	}
